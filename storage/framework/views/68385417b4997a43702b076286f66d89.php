        ...
        <div class="row g-0" style="min-height: calc(100vh - 70px);">
            ...
            <div class="col-md-10 offset-md-2 p-5"
                ...
                <div class="bg-white rounded-4 p-5 shadow-sm mx-auto" style="max-width: 900px;">
                    ...
                    <form action="<?php echo e(route('superadmin.manage-event.update', $event->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="meet_id" class="form-select fst-italic text-secondary"
                                        ...
                                        <?php $__currentLoopData = $meets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($meet->id); ?>" <?php echo e(old('meet_id', $event->meet_id) == $meet->id ? 'selected' : ''); ?>>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control fst-italic text-secondary"
                                        placeholder="Enter event name" value="<?php echo e(old('name', $event->name)); ?>"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="code" class="form-control fst-italic text-secondary"
                                        placeholder="Enter event code" value="<?php echo e(old('code', $event->code)); ?>"
                                        style="border: 1px solid #dee2e6; border-radius: 10px; padding: 10px;">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="fee" class="form-control fst-italic text-secondary"
                                        placeholder="Enter fee amount" value="<?php echo e(old('fee', $event->fee)); ?>"
                                        style="border: 1px solid #dee2e6; border-radius: 10px; padding: 10px;">
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="gender" class="form-select fst-italic text-secondary"
                                        ...
                                        <option value="Male" <?php echo e(old('gender', $event->gender) == 'Male' ? 'selected' : ''); ?>>Male</option>
                                        <option value="Female" <?php echo e(old('gender', $event->gender) == 'Female' ? 'selected' : ''); ?>>Female</option>
                                        <option value="Mixed" <?php echo e(old('gender', $event->gender) == 'Mixed' ? 'selected' : ''); ?>>Mixed</option>
                                    </select>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="age_group" class="form-control fst-italic text-secondary"
                                        placeholder="e.g. 15-17" value="<?php echo e(old('age_group', $event->age_group)); ?>"
                                        style="border: 1px solid #dee2e6; border-radius: 10px; padding: 10px;">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="heat" class="form-control fst-italic text-secondary"
                                        placeholder="Number of heats" value="<?php echo e(old('heat', $event->heat)); ?>"
                                        style="border: 1px solid #dee2e6; border-radius: 10px; padding: 10px;">
                                </div>

                                <div class="mb-3 pt-4">
                                    <div class="form-check p-3 rounded-3" style="border: 1px solid #dee2e6;">
                                        <input type="checkbox" name="relay" value="1" class="form-check-input" id="relay" <?php echo e(old('relay', $event->relay) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\.gemini\antigravity\scratch\BDT-K1-Swiming-System\resources\views/dashboard/superadmin/actions/ManageMeet/edit-event-sadm.blade.php ENDPATH**/ ?>