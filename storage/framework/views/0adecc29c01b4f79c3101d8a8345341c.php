...
<?php $__env->startSection('title', 'Create Meet'); ?>
        ...
        <div class="row g-0" style="min-height: calc(100vh - 70px);">
            ...
            <div class="col-md-10 offset-md-2 p-5"
                ...
                <div class="bg-white rounded-4 p-5 shadow-sm mx-auto" style="max-width: 900px;">
                    ...
                    <form action="<?php echo e(route('superadmin.manage-meet.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control fst-italic text-secondary"
                                        placeholder="meet name" value="<?php echo e(old('name')); ?>"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="code" class="form-control fst-italic text-secondary"
                                        placeholder="meet code" value="<?php echo e(old('code')); ?>"
                                        style="border: 1px solid #dee2e6; border-radius: 10px; padding: 10px;">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="end_date" class="form-control fst-italic text-secondary"
                                        placeholder="end date" value="<?php echo e(old('end_date')); ?>"
                                        style="border: 1px solid #dee2e6; border-radius: 10px; padding: 10px;">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="venue" class="form-control fst-italic text-secondary"
                                        placeholder="venue" value="<?php echo e(old('venue')); ?>"
                                        style="border: 1px solid #dee2e6; border-radius: 10px; padding: 10px;">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="created_by" class="form-control fst-italic text-secondary"
                                        placeholder="created" value="<?php echo e(old('created_by')); ?>"
                                        style="border: 1px solid #dee2e6; border-radius: 10px; padding: 10px;">
                                </div>
                                    <div class="mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\.gemini\antigravity\scratch\BDT-K1-Swiming-System\resources\views/dashboard/superadmin/actions/ManageMeet/create-sadm.blade.php ENDPATH**/ ?>