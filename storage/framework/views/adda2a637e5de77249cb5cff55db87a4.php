...
<section class="login-page">
    ...
    <div class="login-left">
        <div class="login-card">
            ...
            <form action="<?php echo e(route('login.form.password')); ?>" method="GET"> 
                <?php echo csrf_field(); ?>
            ...
            <p class="signup-text" style="gudea-regular">Belum punya akun?
                <a href="<?php echo e(route('register.role')); ?>" style="gudea-bold">Daftar di sini</a>
            </p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\.gemini\antigravity\scratch\BDT-K1-Swiming-System\resources\views/public/auth/login-form-email.blade.php ENDPATH**/ ?>