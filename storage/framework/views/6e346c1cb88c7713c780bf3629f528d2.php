...
<?php $__env->startSection('title', 'Payment Admin'); ?>
...
<div class="container-fluid p-0">
    <div class="row g-0" style="height: calc(100vh - 80px); overflow: hidden;">
        ...
        <div class="col-md-6 bg-light d-flex align-items-center justify-content-center p-0">
             <img src="<?php echo e(asset('images/Admin/regis-admin.jpg')); ?>" alt="Payment Admin" class="img-fluid w-100 h-100" style="object-fit: cover;">
        </div>
            ...
            <div class="card border-0 shadow-lg rounded-4 p-4" style="width: 500px; max-width: 90%; height: fit-content;">
                <div class="card-body">
                    ...
                    <div class="tab-content" id="paymentTabContent">
                        ...
                        <div class="tab-pane fade" id="qris" role="tabpanel">
                            <div class="text-center mb-3">
                                <img src="<?php echo e(asset('images/Admin/qris.jpg')); ?>" alt="QRIS Code" class="img-fluid" style="max-width: 300px; border-radius: 10px;">
                    ...
                    <div class="d-flex gap-3 mt-4">
                        <a href="<?php echo e(route('admin.register')); ?>" class="btn btn-secondary w-50 fw-bold py-2 rounded-3">Back</a>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (confirmBtn) {
            confirmBtn.addEventListener('click', function() {
                ...
                // AJAX Upload
                fetch('<?php echo e(route("admin.payment.upload")); ?>', {
                    method: 'POST',
                    body: formData
                })
                    ...
                    if (data.success) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                // Build redirect URL
                                const redirectUrl = "<?php echo e(route('admin.register')); ?>" + "?" + currentParams.toString();
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\.gemini\antigravity\scratch\BDT-K1-Swiming-System\resources\views/dashboard/admin/actions/payment-admin.blade.php ENDPATH**/ ?>