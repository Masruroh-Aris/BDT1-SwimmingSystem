            ...
            <div class="col-md-10 offset-md-2 p-5"
                ...
                <div class="bg-white rounded-4 p-5 shadow-sm mx-auto animation-fade-in" style="max-width: 900px;">
                    <div class="d-flex justify-content-between align-items-center mb-5">
                        ...
                        <a href="{{ route('superadmin.manage-event') }}" class="btn btn-outline-secondary rounded-pill px-4">
                            <i class="bi bi-arrow-left me-2"></i>Back
                        </a>
                    </div>

                    <div class="text-center mb-5">
                        <h2 class="fw-bold text-dark">{{ $event->name }}</h2>
                        <span class="badge bg-success px-3 py-2 rounded-pill mt-2">{{ $event->status }}</span>
                    </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="mb-4 border-bottom pb-3">
                                ...
                                <div class="fw-bold fs-5">{{ $event->age_group }}</div>
                            </div>
                            <div class="mb-4 border-bottom pb-3">
                                <label class="text-secondary small d-block mb-1">Heat</label>
                                <div class="fw-bold fs-5">{{ $event->heat }}</div>
                            </div>
                            <div class="mb-4 border-bottom pb-3">
                                <label class="text-secondary small d-block mb-1">Relay Event</label>
                                <div class="fw-bold fs-5 {{ $event->relay ? 'text-success' : 'text-danger' }}">
                                    {{ $event->relay ? 'Yes' : 'No' }}
                                </div>
                            </div>
                        </div>
