            ...
            <div class="col-md-10 offset-md-2 p-5"
                ...
                <div class="bg-white rounded-4 p-5 shadow-sm mx-auto animation-fade-in" style="max-width: 900px;">
                    <div class="d-flex justify-content-between align-items-center mb-5">
                        ...
                        <a href="{{ route('superadmin.dashboard') }}" class="btn btn-outline-secondary rounded-pill px-4">
                            <i class="bi bi-arrow-left me-2"></i>Back
                        </a>
                    </div>

                    <div class="text-center mb-5">
                        <h2 class="fw-bold text-dark">{{ $meet->name }}</h2>
                        @php
                        ...
                        @endphp
                        <span class="badge {{ $badgeClass }} px-3 py-2 rounded-pill mt-2">{{ $meet->status }}</span>
                    </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="mb-4 border-bottom pb-3">
                                ...
                                <div class="fw-bold fs-5">{{ $meet->code }}</div>
                            </div>
                            <div class="mb-4 border-bottom pb-3">
                                <label class="text-secondary small d-block mb-1">Start Date</label>
                                <div class="fw-bold fs-5">{{ $meet->start_date ? $meet->start_date->format('d M Y') : '-' }}</div>
                            </div>
                            <div class="mb-4 border-bottom pb-3">
                                <label class="text-secondary small d-block mb-1">End Date</label>
                                <div class="fw-bold fs-5">{{ $meet->end_date ? $meet->end_date->format('d M Y') : '-' }}</div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-4 border-bottom pb-3">
                                ...
                                <div class="fw-bold fs-5">{{ $meet->venue }}</div>
                            </div>
                            <div class="mb-4 border-bottom pb-3">
                                <label class="text-secondary small d-block mb-1">Created By</label>
                                <div class="fw-bold fs-5">{{ $meet->created_by }}</div>
                            </div>
                            <div class="mb-4 border-bottom pb-3">
                                <label class="text-secondary small d-block mb-1">Notes</label>
                                <div class="fw-bold fs-5 fst-italic text-muted">{{ $meet->notes ?? '-' }}</div>
                            </div>
                        </div>
                    </div>
                </div>
