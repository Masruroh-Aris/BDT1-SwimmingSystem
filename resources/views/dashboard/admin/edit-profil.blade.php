        ...
        <div class="col-md-2 bg-white border-end py-4 d-flex flex-column align-items-center position-fixed h-100" style="top: 70px; z-index: 100;">
            ...
            <div class="w-100 px-3">
                <nav class="nav flex-column gap-3">
                    <a href="{{ route('admin.dashboard') }}" class="nav-link text-dark fs-5">Registration</a>
                    <a href="#" class="nav-link text-dark fs-5 mt-4">Logout</a>
                </nav>
            </div>
        </div>
                ...
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-3 py-2" name="name" value="Admin" placeholder="Enter name">
                        </div>

                        {{-- Username --}}
                        <div class="col-md-6">
                            <label class="form-label text-secondary small">Username</label>
                            <input type="text" class="form-control rounded-3 py-2" name="username" value="admin" placeholder="Enter username">
                        </div>

                        {{-- Email (Read Only) --}}
                        <div class="col-12">
                            <label class="form-label text-secondary small">Email</label>
                            <input type="email" class="form-control bg-light rounded-3 py-2" name="email" value="admin@example.com" readonly style="cursor: not-allowed;">
