        ...
        <div class="col-md-2 bg-white border-end py-4 d-flex flex-column align-items-center position-fixed h-100" style="top: 70px; z-index: 100;">
            ...
            <div class="w-100 px-3">
                <nav class="nav flex-column gap-3">
                    ...
                    <a href="{{ route('operator.certificate.index') }}" class="nav-link text-dark fs-5 fw-bold border-bottom border-dark pb-1">Certificate</a>
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('operator.certificate.store') }}" method="POST" enctype="multipart/form-data" id="certForm">
                                @csrf
                                ...
                                {{-- Layout Editor Section (Hidden initially) --}}
                ...
                <div class="col-12">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle bg-white rounded shadow-sm">
                            ...
                            <tbody>
                                @forelse($currentCertificates as $cert)
                                <tr>
                                    <td class="ps-4 fw-bold">{{ $cert->event_name }}</td>
                                    <td>
                                        <img src="{{ asset($cert->image_path) }}" alt="Bg" class="rounded shadow-sm" style="height: 50px; object-fit: cover;">
                                    </td>
                                    <td class="small text-muted">{{ $cert->updated_at->format('d M Y') }}</td>
                                </tr>
                                @empty
                                <tr>
