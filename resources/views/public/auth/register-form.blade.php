...
@section('title', 'Buat Akun Baru | Swim Event')
...
<section class="login-page">
    ...
    <div class="login-left">
        <div class="login-card">
            ...
            {{-- Google Register --}}
            <a href="{{ route('google.register', ['role' => $role, 'subrole' => $subrole]) }}" class="btn btn-google w-100">
    ...
    <div class="login-right">
        <img src="{{ asset('images/ex.jpg') }}" class="login-image" alt="Swim Event Illustration">
    </div>
    ...
    @if(session('registration_success'))
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "{{ route('meets.index') }}"; // Or home '/'
            }
        });
    @endif
</script>
